...
\begin{soln}
    \\Let $\mathbf{z_k}$ be an arbitrary point in our training set. In order for our predictor to correctly predict the label of this arbitrary point, it must match the sign of the chosen training point, i.e.
